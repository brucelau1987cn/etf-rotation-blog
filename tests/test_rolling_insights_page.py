...
def test_daily_rolling_reports_cover_latest_dates():
    ...
    for marker in (
        ...
        assert marker in page + component + data + hist + static_05
    assert "2026-08-06" in data and "2026-08-05" in data
    assert "rollingDailyReports['2026-08-06']" in page
...
def test_insight_navigator_is_daily_only_after_merge():
    ...
    assert "/rolling/insights/2026-08-06 /rolling/insights/ 301" in redirects
