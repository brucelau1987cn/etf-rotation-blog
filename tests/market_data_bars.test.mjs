...
import { onRequestGet, aggregateDailyBars } from '../functions/api/public/v1/market-data/bars.js';
...
test('market-data bars returns a normalized Yahoo daily series', async () => {
  ...
  globalThis.fetch = async (url) => {
    ...
    return Response.json({ chart: { result: [{ timestamp: [1704067200, 1704153600], indicators: { quote: [{ open: [1, 2], high: [2, 3], low: [0.5, 1.5], close: [1.5, 2.5], volume: [10, 20] }] } }] } });
  };
  try {
