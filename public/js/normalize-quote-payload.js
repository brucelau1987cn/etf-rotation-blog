/**
 * Browser IIFE mirror of src/lib/normalizeQuotePayload.mjs
 * Keep in sync via: node scripts/sync_quote_adapter.mjs
 * Attaches window.EtfQuote = { normalizeQuotePayload, findQuoteItem, aShareSymbolsParam, quoteMapByCode, bareSymbol }
 */
(function (global) {
  'use strict';
  ...
  function findQuoteItem(payloadOrNormalized, code) {
  ...
  function aShareSymbolsParam(codes) {
  ...
  function quoteMapByCode(normalized) {
    const map = new Map();
