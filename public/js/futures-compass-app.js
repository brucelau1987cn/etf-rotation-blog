...
function render(payload) {
  ...
  document.getElementById('source-label').textContent=payload.source||'新浪期货'; document.getElementById('data-time').textContent=`数据 ${(payload.generated_at||'—').replace('T',' ').replace('+08:00','')}`;
