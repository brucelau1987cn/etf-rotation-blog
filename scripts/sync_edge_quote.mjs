...
const thsHelperTarget = join(root, 'functions', 'api', 'public', 'v1', '_ths.js');

if (!existsSync(source) || !existsSync(chipSource) || !existsSync(baostockSource) || !existsSync(thsSource)) {
  console.error(`edge-quote-api source not found: ${source} / ${chipSource} / ${baostockSource} / ${thsSource}`);
  process.exit(1);
}
...
const text = readFileSync(source, 'utf8')
  ...
  .replaceAll("from './ths.js'", "from './_ths.js'");
...
copyFileSync(thsSource, thsHelperTarget);
